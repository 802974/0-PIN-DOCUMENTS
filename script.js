...
const documents = [
    ...
    },
    {
        ...
        path: "TH 24/REF-016-15 Section 7 _ TH.pdf",
        category: "TH24",
        slot: "24",
        type: "PDF",
        size: "3.0 MB"
...
function sortDocuments(docs, sortBy) {
    switch(sortBy) {
        case 'name':
            docs.sort((a, b) => {
                // If both have section numbers, sort by section
        ...
        case 'name-desc':
            docs.sort((a, b) => {
                // If both have section numbers, sort by section descending
                if (a.section !== undefined && b.section !== undefined) {
...
function openDocument(path) {
    // Open PDF in modal using object tag
    try {
        currentPdfPath = path;
